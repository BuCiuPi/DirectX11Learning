...
bool IrradianceShader::Initialize(ID3D11Device* device)
{
	...
	LoadShader(device, L"IrradianceShader.hlsl", polygonLayout, ARRAYSIZE(polygonLayout));
...
bool IrradianceShader::Render(ID3D11DeviceContext* deviceContext, int indexCount,
