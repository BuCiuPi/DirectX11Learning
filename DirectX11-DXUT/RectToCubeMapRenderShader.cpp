...
RectToCubeMapRenderShader::RectToCubeMapRenderShader()
{
}
...
bool RectToCubeMapRenderShader::Initialize(ID3D11Device* device)
{
	...
	LoadShader(device, L"RectToCubeMap.hlsl", polygonLayout, ARRAYSIZE(polygonLayout));
...
bool RectToCubeMapRenderShader::Render(ID3D11DeviceContext* deviceContext, int indexCount,
