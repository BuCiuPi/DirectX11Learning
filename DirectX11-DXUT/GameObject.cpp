...
bool GameObject::Initialize(const std::string& filePath, ID3D11Device* device, ID3D11DeviceContext* deviceContext, ConstantBuffer<CB_VS_vertexshader>* cb_vs_vertexshader, ConstantBuffer<CB_VS_Skinned>* cb_vs_skinnedBuffer)
{

	if (!this->model.Initialize(filePath, device, deviceContext, cb_vs_vertexshader, cb_vs_skinnedBuffer))
		return false;
