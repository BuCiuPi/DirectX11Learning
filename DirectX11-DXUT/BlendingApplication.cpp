...
bool BlendingApplication::Init(int nShowCmd)
{
...
void BlendingApplication::DrawScene()
{
...
void BlendingApplication::UpdateScene(float dt)
{
...
void BlendingApplication::BuildGeometryBuffer()
{
	MeshData grid;
...
void BlendingApplication::BuildWaveBuffer()
{
...
void BlendingApplication::BuildBoxBuffer()
{
	MeshData box;
...
void BlendingApplication::BuildConstantBuffer()
{
...
void BlendingApplication::CleanupDevice()
{
	ReleaseCOM(mLandVB);
	ReleaseCOM(mLandIB);
	ReleaseCOM(mWavesVB);
...
float BlendingApplication::GetHeight(float x, float z) const
{
	return 0.3f * (z * sinf(0.1f * x) + x * cosf(0.1f * z));
}

XMFLOAT3 BlendingApplication::GetHillNormal(float x, float z) const
{
...
void BlendingApplication::BuildFX()
{
...
void BlendingApplication::BuildBlendState()
{
