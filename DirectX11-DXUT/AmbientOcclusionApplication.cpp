...
bool AmbientOcclusionApplication::Init(int nShowCmd)
{
...
void AmbientOcclusionApplication::DrawScene()
{
...
void AmbientOcclusionApplication::UpdateScene(float dt)
{
...
void AmbientOcclusionApplication::BuildGeometryBuffer()
{
}


void AmbientOcclusionApplication::BuildConstantBuffer()
{
...
void AmbientOcclusionApplication::BuildFX()
{
	mSky->BuildSkyFX(g_pd3dDevice);
	BuildNanoSuitFX();
}

void AmbientOcclusionApplication::BuildNanoSuitFX()
{
